...
# Export all symbols:
symbols_zh = [_pad] + list(_punctuation) + list(_letters) + list(_letters_ipa) + list(_numbers) + list(_zhpunc) + _py
# symbols_en = [_pad] s+ list(_punctuation) + list(_letters) + list(_letters_ipa)
# print(symbols_zh[:178])
# Special symbol ids
SPACE_ID = symbols_zh.index(" ")
# print(SPACE_ID)
